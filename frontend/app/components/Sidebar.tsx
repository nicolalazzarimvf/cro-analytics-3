...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    icon: (
      <svg className="shrink-0 fill-current" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
        <path d="M3.5 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm9 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM8 10a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm-4.5 5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm9 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z" />
        <path d="M4.78 3.67a1 1 0 0 1 1.37.36L7.3 6.04a1 1 0 0 1-1.73 1l-1.14-2.01a1 1 0 0 1 .35-1.36Zm6.44 0a1 1 0 0 0-1.37.36L8.7 6.04a1 1 0 0 0 1.73 1l1.14-2.01a1 1 0 0 0-.35-1.36ZM4.78 12.33a1 1 0 0 0 1.37-.36L7.3 9.96a1 1 0 0 0-1.73-1l-1.14 2.01a1 1 0 0 0 .35 1.36Zm6.44 0a1 1 0 0 1-1.37-.36L8.7 9.96a1 1 0 0 1 1.73-1l1.14 2.01a1 1 0 0 1-.35 1.36Z" />
      </svg>
    ),
  },
  {
